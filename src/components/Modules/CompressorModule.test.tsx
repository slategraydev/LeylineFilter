...
describe('CompressorModule', () => {
    ...
    it('renders correctly', () => {
        ...
        expect(screen.getByText(/Threshold: -20.0 dB/)).toBeInTheDocument();
        expect(screen.getByText(/Ratio: 4.0:1/)).toBeInTheDocument();
    });
    ...
    it('disables inputs when config is disabled', () => {
        render(<CompressorModule {...defaultProps} config={{ ...defaultProps.config, enabled: false }} />);
