    ...
    return (
        ...
        >
            <div className="control-group">
                <label>
                    Drive: {config.drive.toFixed(1)}x
                    <input
                        type="range"
                        min="1.0"
                        max="10.0"
            ...
            <div className="control-group">
                <label>
                    Tilt (EQ Bias): {config.tilt.toFixed(1)} dB
                    <input
                        type="range"
                        min="-12.0"
                        max="12.0"
                        ...
                        disabled={!config.enabled}
                        onChange={(e) =>
                            updateConfig({ tilt: parseFloat(e.target.value) })
                        }
                    />
                </label>
            </div>
            <div className="control-group">
                <label>
                    ...
                    <input
                        ...
                        disabled={!config.enabled}
                        onChange={(e) =>
                            updateConfig({ mix: parseFloat(e.target.value) })
                        }
                    />
                </label>
            </div>
